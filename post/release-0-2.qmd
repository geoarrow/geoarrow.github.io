...
- Regenerate data to fix some mistakes (e.g., some files don't contain nulls that were meant to, they really should be streams instead of arrow files)
- Add naturalearth countries/cities as spherical test data
- Make sure there are largeish test data sets for all geometry types including mixed types
- Also include GeoParquet output
...
- Is it worth making sure that Arrow to/from works seamlessly?
